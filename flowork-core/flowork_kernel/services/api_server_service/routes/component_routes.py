...
# File NAME : C:\FLOWORK\flowork-core\flowork_kernel\services\api_server_service\routes\component_routes.py JUMLAH BARIS 256 
#######################################################################
...
class ComponentRoutes(BaseApiRoute):
    ...
    async def handle_get_component_icon(self, request):
        ...
        assets_path = os.path.join(self.kernel.project_root_path, "assets")
