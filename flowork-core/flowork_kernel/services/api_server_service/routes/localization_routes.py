...
# File NAME : C:\FLOWORK\flowork-core\flowork_kernel\services\api_server_service\routes\localization_routes.py JUMLAH BARIS 33 
#######################################################################

from .base_api_route import BaseApiRoute
class LocalizationRoutes(BaseApiRoute):
    """
    Menyediakan rute API untuk mengambil data kamus bahasa yang sudah digabung.
    """
